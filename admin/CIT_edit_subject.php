...
$row=mysqli_fetch_array($result);
    ...
    <div class="controls">
    <input type="text" name="Subject_Code" class="Subject_Code" value="<?php echo $row['subject_code']; ?>">
    </div>
    </div>
    ...
    <div class="controls">
    <input type="text" name="Subject_Title" class="Subject_Title" value="<?php echo $row['subject_title']; ?>">
    </div>
    </div>
...
if (Subject_Code && Subject_Title && Category && Semester){	
    ...
    jQuery.ajax({
        ...
        data: formData,
            ...
            showNotification({
message: "Subject Entry Successfully Updated",
type: "success", 
autoClose: true, 
duration: 5 
