...
<h2><font color="white">ADD Schedule</font></h2>
	<a class="btn btn-primary"  href="SAS_schedule.php">  <i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
	<hr>
<form id="" class="form-horizontal" method="POST" action="SAS_save.php">	
	<input type="hidden" name='redirect' value="./SAS_add.php">
    <fieldset>
	</br>
	<div class="hai_naku">
