...
<h2><font color="white">BSIT Schedule List</font></h2>
	<a class="btn btn-primary"  href="CIT_add.php">  <i class="icon-plus-sign icon-large"></i>&nbsp;Add BSIT Schedule</a>
	<hr>
  ...
  <ul>
    ...
    <li class="active"><a href="CIT_BSIT.php"><font color="white">BSIT</a></font></li>
...
<div class="demo_jui">
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where CYS like '%BSIT%' and type=''")or die(mysqli_error());
...
<tr class="del<?php echo $id ?>">
	...
	<a class="btn btn-info" href="CIT_edit_BSIT.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
