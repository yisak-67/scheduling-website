...
<h2><font color="white">Edit Schedule</font></h2>
	<a class="btn btn-primary"  href="COE_BSED.php">  <i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
	<hr>
...
<option><?php echo $sy_row['sy']; ?></option>
 <?php } ?>
   ...
   <select name="CYS" class="span3" id="CYS">
	...
	<?php $CYS_query=mysqli_query($conn,"select * from course where course_year_section like '%BEED%'  or  course_year_section like '%BSED%' or
...
duration: 5 
		 ...
		 var delay = 2000;
		setTimeout(function(){ window.location = 'COE_BSED.php';}, delay);  
