...
<h2><font color="white">Course Year Section List</font></h2>
	<a class="btn btn-primary" href="CIT_add_course.php" >  <i class="icon-plus-sign icon-large"></i>&nbsp;Add Course Year Section</a>
	<hr>
...
<?php 
$result=mysqli_query($conn,"select * from course where Department like '%college of industrial technology%'")or die(mysqli_error());
...
<tr class="del<?php echo $id ?>">
	...
	<a class="btn btn-info" href="CIT_update_course.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
