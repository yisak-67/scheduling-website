...
<h2><font color="white">Exam Schedule List</font></h2>
  ...
  <ul>
    ...
    <li  class="active"><a href="CIT_exam_BSHRM.php"><font color="white">BSHRM</font></a></li>
    ...
    <li><a href="CIT_exam_BSED.php"><font color="white">BSEd</font></a></li>
...
<tr class="del<?php echo $id ?>">
	...
	<a class="btn btn-info" href="CIT_edit_exam2.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
