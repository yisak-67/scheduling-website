...
<h2><font color="white">BSED Schedule List</font></h2>
	<a class="btn btn-primary"  href="COE_add.php">  <i class="icon-plus-sign icon-large"></i>&nbsp;Add BSEd Schedule</a>
	<hr>
	<div class="pagination">
  <ul>
    <li><a href="COE_schedule.php"><font color="white">All</font></a></li>
  
    <li><a href="COE_BEED.php"><font color="white">BEEd</font></a></li>
    <li class="active"><a href="COE_BSED.php"><font color="white">BSEd</font></a></li>
...
<div class="demo_jui">
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where CYS like '%BSED%' and type=''")or die(mysqli_error());
...
<tr class="del<?php echo $id ?>">
	...
	<a class="btn btn-info" href="edit_COE_BSED.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
