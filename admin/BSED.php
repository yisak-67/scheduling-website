...
<br>
  ...
  <ul>
    ...
    <li  class="active"><a href="BSED.php"><font color="white">BSEd</font></a></li>
...
<div class="table_background">
		...
		<table  id="demoTable"  class="table table-striped table-bordered table-condensed">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where type='' and CYS like '%BSED%' order by schedule_id DESC")or die(mysqli_error());
