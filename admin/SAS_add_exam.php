...
<h2><font color="white">Add Exam Schedule</font></h2>
	<a class="btn btn-primary"  href="SAS_exam_schedule.php">  <i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
	<hr>
<form id="" method="POST" class="form-horizontal" action="save_exam.php">	
    <fieldset>
	</br>
	<input type="hidden" name='redirect' value="./SAS_add_exam.php">
	<div class="hai_naku">
...
if (day && time_start && time_end && semester && sy && CYS && subject && teacher && room ){	
    ...
    jQuery.ajax({
        ...
        data: formData,
		 ...
		 var delay = 2000;
		setTimeout(function(){ window.location = 'SAS_exam_schedule.php';}, delay);  
