...
<h2><font color="white">Exam Schedule List</font></h2>
  ...
  <ul>
    ...
    <li class="active"><a href="CIT_exam_BSIT.php"><font color="white">BSIT</a></font></li>
...
<tr class="del<?php echo $id ?>">
	...
	<a class="btn btn-info" href="CIT_edit_exam3.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
