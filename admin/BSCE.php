...
<br>
  ...
  <ul>
    ...
    <li  class="active"><a href="BSCE.php"><font color="white">BSCE</font></a></li>
...
<div class="table_background">
		...
		<table  id="demoTable"  class="table table-striped table-bordered table-condensed">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where type='' and CYS like '%BSCE%' order by schedule_id DESC")or die(mysqli_error());
