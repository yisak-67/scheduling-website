...
<h2><font color="white">Edit Course Year Section List</font></h2>
    ...
    <div class="controls">
    <input type="text" name="CYS" class="CYS" value="<?php echo $row['course_year_section'];?>">
    </div>
    </div>
    ...
    <div class="controls">
    <input type="text" name="Major" class="Major" value="<?php echo $row['major'];?>">
    </div>
    </div>
