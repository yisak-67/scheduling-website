...
<h2><font color="white">Teachers List</font></h2>
	<a class="btn btn-primary"  href="CIT_add_teacher.php">  <i class="icon-plus-sign icon-large"></i>&nbsp;Add Teacher</a>
	<hr>
...
<tr class="del<?php echo $id ?>">
	...
	<a class="btn btn-info" href="CIT_edit_teacher.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
