...
<h2><font color="white">ADD Schedule</font></h2>
	<a class="btn btn-primary"  href="COE_schedule.php">  <i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
	<hr>
<form id="save_voter" class="form-horizontal" method="POST" action="COE_save.php">	
    <fieldset>
	</br>
	<div class="hai_naku">
...
<option><?php echo $sy_row['sy']; ?></option>
 <?php } ?>
   ...
   <select name="CYS" class="span3" id="CYS">
	<option>--Select--</option>
	<?php $CYS_query=mysqli_query($conn,"select * from course where course_year_section like '%BSED%' or  course_year_section like '%BEED%'  
 or  course_year_section like '%Graduate School%'  
