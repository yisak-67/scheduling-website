...
<h2><font color="white">BSIS Schedule List</font></h2>
	<a class="btn btn-primary"  href="COE_add.php">  <i class="icon-plus-sign icon-large"></i>&nbsp;Add Graduate School Schedule</a>
	<hr>
  ...
  <ul>
    ...
    <li class="active"><a href="COE_GS.php"><font color="white">Graduate School</font></a></li>
  </ul>
</div>
...
<div class="demo_jui">
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where CYS like '%Graduate School%' and type=''")or die(mysqli_error());
...
<tr class="del<?php echo $id ?>">
	...
	<a class="btn btn-info" href="edit_COE_GS.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
