...
<h2><font color="white">Add Exam Schedule</font></h2>
	<a class="btn btn-primary"  href="CIT_exam_schedule.php">  <i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
	<hr>
...
duration: 5 
		 ...
		 var delay = 2000;
		setTimeout(function(){ window.location = 'CIT_exam_schedule.php';}, delay);  
