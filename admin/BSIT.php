...
<br>
  ...
  <ul>
    ...
    <li class="active"><a href="BSIT.php"><font color="white">BSIT</a></font></li>
...
<div class="table_background">
		...
		<table  id="demoTable"  class="table table-striped table-bordered table-condensed">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where type='' and CYS like '%BSIT%' order by schedule_id DESC")or die(mysqli_error());
