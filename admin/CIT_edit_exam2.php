...
<h2><font color="white">Edit Schedule</font></h2>
	<a class="btn btn-primary"  href="CIT_exam_BSHRM.php">  <i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
	<hr>
...
<option><?php echo $sy_row['sy']; ?></option>
 <?php } ?>
   ...
   <select name="CYS" class="span3" id="CYS">
	...
	<?php $CYS_query=mysqli_query($conn,"select * from course where course_year_section like '%BSIS%' or   
 course_year_section like '%BSHRM%' or  course_year_section like '%BSIT%' or course_year_section like '%BSCE%'
...
duration: 5 
		 ...
		 var delay = 2000;
		setTimeout(function(){ window.location = 'CIT_exam_BSHRM.php';}, delay);  
