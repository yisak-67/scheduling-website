...
<br>
  ...
  <ul>
    ...
    <li class="active"><a href="AB.php"><font color="white">AB</font></a></li>
...
<div class="table_background">
		...
		<table  id="demoTable"  class="table table-striped table-bordered table-condensed">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where type='' and CYS like '%AB%' order by schedule_id DESC")or die(mysqli_error());
