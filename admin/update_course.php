...
<ul class="nav nav-tabs nav-stacked">
  ...
  <li class="active"><a href="course.php"><font color="white">Course Year/Section</font></a></li>
...
<h2><font color="white">Edit Course Year Section List</font></h2>
	<a class="btn btn-primary"  href="course.php">  <i class=" icon-arrow-left icon-large"></i>&nbsp;Back</a>
	<hr>
	<?php
	$result=mysqli_query($conn,"select * from course where course_id='$get_id'")or die (mysqli_query($conn,));
    ...
    <div class="controls">
    <input type="text" name="CYS" class="CYS" value="<?php echo $row['course_year_section'];?>" id="span900">
    </div>
    </div>
    ...
    <div class="controls">
    <input type="text" name="Major" class="Major" value="<?php echo $row['major'];?>" id="span900">
    </div>
    </div>
