...
/////////////////
	...
	$qryreport = mysqli_query($conn,"SELECT * FROM schedule where room='$id_get' and type='Exam' and semester='$semester' and sy='$sy'") or die(mysqli_error());
	...
	$j=$j+1;
			...
			$room = $reportdisp['teacher'];
			 ...
			 $qryleader = mysqli_query($conn,"SELECT * FROM schedule WHERE room='".$leaderid."' and type='Exam' and semester='$semester' and sy='$sy'") or die(mysqli_error());
