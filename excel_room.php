...
$query=mysqli_query($conn,"select * from schedule where  room='$id_get' and semester='$semester' and sy='$sy'")or die(mysqli_error());
...
$semester=$row['semester'];
   ...
   $worksheet1->write_string(7,4,"Teacher");
   $worksheet1->write_string(19,0,"TTH Schedule");
   $worksheet1->write_string(20,0,"Day");
   $worksheet1->write_string(20,1,"Time");
   $worksheet1->write_string(20,2,"Course Year Section");
     $worksheet1->write_string(20,3,"Subject");
   $worksheet1->write_string(20,4,"Teacher");
...
/////////////////
	...
	$qryreport = mysqli_query($conn,"SELECT * FROM schedule where room='$id_get' and type='' and day1='MWF' and semester='$semester' and sy='$sy'") or die(mysqli_error());
	...
	$j=$j+1;
			...
			$room = $reportdisp['teacher'];
			
			
			
			 $leaderid = $reportdisp['room']; 
			 
			 $qryleader = mysqli_query($conn,"SELECT * FROM schedule WHERE room='".$leaderid."' and type='' and day1='MWF' and semester='$semester' and sy='$sy'") or die(mysqli_error());
...
/////////////////
	...
	$qryreport1 = mysqli_query($conn,"SELECT * FROM schedule where room='$id_get' and type='' and day1='TTH' and semester='$semester' and sy='$sy'") or die(mysqli_error());
	...
	$j=$j+1;
			...
			$room = $reportdisp['teacher'];
			 ...
			 $qryleader = mysqli_query($conn,"SELECT * FROM schedule WHERE room='".$leaderid."' and type='' and day1='TTH' and semester='$semester' and sy='$sy'") or die(mysqli_error());
				$leader = mysqli_fetch_assoc($qryleader);
