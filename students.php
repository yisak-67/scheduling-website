...
<ul class="nav nav-tabs"> 
  <li><a href="#home" data-toggle="tab"><font color="white"><i class="icon-user-md icon-large"></i>Teacher</font></a></li>
  <li class="active"><a href="#profile" data-toggle="tab"><i class="icon-user icon-large"></i>Students</a></li>
  <li><a href="#messages" data-toggle="tab"><font color="white"><i class="icon-columns icon-large"></i>Room</a></font></li>
</ul>

<div class="tab-content">
  <div class="tab-pane active" id="home">
  <div class="hero-unit-y">
<h2>Search Students Class Schedule</h2>
